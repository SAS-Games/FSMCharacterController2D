...
You find yourself at a crossroads with three different paths. Each path represents a distinct adventure. Choose one of the following paths to discover what awaits you:->SelectPath
...
+[Return to Crossroads]->SelectPath
+[Done]->END
