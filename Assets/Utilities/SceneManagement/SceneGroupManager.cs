...
namespace Systems.SceneManagement
{
    public class SceneGroupManager
    {
        ...
        public async Task LoadScenes(SceneGroup group, IProgress<float> progress, bool reloadDupScenes = false, bool ignoreOptional = false)
        {
            ...
            for (var i = 0; i < totalScenesToLoad; i++)
            {
                ...
                if (ignoreOptional && sceneData.IsOptinal) 
                    continue;
